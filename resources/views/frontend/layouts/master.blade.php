...
<head>
    ...
    <!-- Bootstrap css -->
    <link id="rtl-link" rel="stylesheet" type="text/css" href="{{ asset('assets/asset_frontend/css/vendors/bootstrap.css') }}">

    <!-- Loader Normalize css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/asset_frontend/css/normalize.min.css') }}">

    <!-- Swiper css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/asset_frontend/css/vendors/swiper/swiper-bundle.min.css') }}">
