                                    ...
                                    <div class="filter-box">
                                        <validation-provider name="warehouse" rules="required"
                                            ...
                                            <v-select @input="Selected_Warehouse" :disabled="details.length > 0"
                                                ...
                                                :options="warehouses.map(warehouses => ({
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        @if ($symbol_placement == 'before')
                                                            <h6 class="fw-semibold m-0 font_16">{{ $currency }}
                                                                @{{ detail.subtotal.toFixed(2) }}</h6>
                                                        @else
                                                            <h6 class="fw-semibold m-0 font_16">@{{ detail.subtotal.toFixed(2) }}
                                                                {{ $currency }}</h6>
                                                        @endif
                                        ...
                                        <div class="cart-summery">
                                            ...
                                            <div class="pt-3 border-top border-gray-300 summery-total">
                                                <h5 class="summery-item m-0">
                                                    ...
                                                    @if ($symbol_placement == 'before')
                                                        <span>{{ $currency }} @{{ GrandTotal.toLocaleString('en-US', {
    ...
    <script>
        ...
        var app = new Vue({
            ...
            methods: {
                ...
                //---------------------------------Get Product Details ------------------------\\
                // calling data product detail when choose it
                Get_Product_Details(product_id, variant_id) {
                    // console.log("produk yang dipilih : " + product_id);
                    // console.log("variant yang dipilih : " + variant_id);
                ...
                Get_Products_By_Warehouse(id) {
                    ...
                    axios
                        .get("/pos/autocomplete_product_pos/" + id +
                            ...
                            this.brand_id)
                        .then(response => {
                            console.log("Respon data autocomplete product pos : " + JSON.stringify(response));
                ...
                getProducts(page = 1) {
                    ...
                    axios
                        ...
                        .then(response => {
                            console.log("Respon data get_products_post : " + JSON.stringify(response));
