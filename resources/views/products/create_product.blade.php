            ...
            <div class="card mt-5">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4"
                            v-if="
                        product.type == 'is_single' || product.type == 'is_variant' || product.type == 'is_new_variant'">
                            <label for="cost">
                                {{ __('translate.Product_Cost') }} <span class="field_required">*</span>
                            </label>
                        ...
                        <div class="form-group col-md-4"
                            ...
                            <label for="price">
                                {{ __('translate.Product_Price') }} <span class="field_required">*</span>
                            </label>
                                ...
                                <table class="table table-hover table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="variant in variants">
                                            ...
                                            <td>
                                                <v-select placeholder="Choose Attribute Value"
                                            ...
                                            <td>
                                                <input required class="form-control" v-model="variant.variantCost">
                                            </td>
                                            <td>
                                                <input required class="form-control" v-model="variant.variantPrice">
                                            </td>
                                            <td>
                    ...
                    <div class="col-md-12 mb-2">
                        <div class="form-check form-check-inline">
                            <label class="checkbox checkbox-primary" for="is_imei">
                                ...
                                <span>
                                    {{ __('translate.Product_Has_Imei/Serial_number') }}
                                </span>
