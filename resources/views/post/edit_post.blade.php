                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <span class="error" v-if="errors && errors.is_active">
                                @{{ errors.is_active[0] }}
                                </span>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                <template v-if="preview" class="mb-4">
                                    <img :src="preview" class="img-fluid w-50" />
                                </template>
                                <img src="{{ $old_photo }}" class="img-thumbnail w-50 old_photo" />
                                <br>
