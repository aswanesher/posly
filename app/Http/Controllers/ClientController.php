...
use App\Imports\ClientImportNew;
use App\Models\User;
...
class ClientController extends Controller
{
        ...
        if (!$user_auth->can('client_view_all') && !$user_auth->can('client_view_own')) {
            ...
            foreach ($clients as $client) {
                ...
                if ($client->status == 1) {
                    ...
                    $item['status'] = '<span class="badge badge-warning">Inactive</span>';
                }
    ...
    public function import_client_process(Request $request)
    {
        dd($request->all());
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        if ($user_auth->can('client_details')) {
            ...
            $item['postalCode'] = $client->postal_code;
            $item['officeName'] = $client->office_name;
            $item['officeAddress'] = $client->office_address;
            $item['officePostalCode'] = $client->office_postal_code;
            $item['officePhone'] = $client->office_phone;
    ...
    public function import_clients(Request $request)
    {
        ...
        if ($user_auth->can('client_add')) {
            ...
            //     //--client address
            //     if ($value['alamat'] != '') {
            //         $row['address'] = $value['alamat'];
            //     } else {
            //         $row['address'] = NULL;
            //     }

            //     //--client office name
            //     if ($value['nama_kantor'] != '') {
            //         $row['office_name'] = $value['nama_kantor'];
            //     } else {
            //         $row['office_name'] = NULL;
            //     }

            //     //--client office phone number
            //     if ($value['telepon_kantor'] != '') {
            //         $row['office_phone'] = $value['telepon_kantor'];
            //     } else {
            //         $row['office_phone'] = NULL;
            //     }

            //     //--client office address
            //     if ($value['alamat_kantor'] != '') {
            //         $row['office_address'] = $value['alamat_kantor'];
            //     } else {
            //         $row['office_address'] = NULL;
            //     }

            //     //--client office postal code
            //     if ($value['kode_pos_kantor'] != '') {
            //         $row['office_postal_code'] = $value['kode_pos_kantor'];
            //     } else {
            //         $row['office_postal_code'] = NULL;
            //     }

            //     //--client postal code
            //     if ($value['kode_pos'] != '') {
            //         $row['postal_code'] = $value['kode_pos'];
            //     } else {
            ...
            //     $check = Client::where('email', $client_value['email'])->first();
            //     if (!$check) {
            //         $client = new Client;
            //         $client->user_id = $user_auth->id;
            ...
            //         $client->postal_code = $client_value['postal_code'];
            //         $client->office_name = $client_value['office_name'];
            //         $client->office_phone = $client_value['office_phone'];
            //         $client->office_address = $client_value['office_address'];
            //         $client->office_postal_code = $client_value['office_postal_code'];
